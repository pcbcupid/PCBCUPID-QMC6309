...
// void PCBCUPID_QMC6309::setMode(uint8_t mode, uint8_t odr) {
//   uint8_t ctrl1 = (0b10 << 5) | (mode & 0x03);  // OSR=4, MODE
//   writeRegister(QMC6309_CONTROL_REG_1, ctrl1);
//   Serial.print("Control Reg 1 set to: 0x"); Serial.println(ctrl1, HEX);

//   uint8_t ctrl2 = (0x04 << 4) | (0x02 << 2);  // ODR=200Hz, RNG=8G
//   writeRegister(QMC6309_CONTROL_REG_2, ctrl2);
//   Serial.print("Control Reg 2 set to: 0x"); Serial.println(ctrl2, HEX);
// }
